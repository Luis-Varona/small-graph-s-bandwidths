#!/bin/bash
#SBATCH --job-name=s_diag_con_bip_graphs_1to15
...
SRC="/home/pusheen/scratch/small-graph-s-bandwidths/data/input/laplacian_integral_con_bip_graphs_1to15.txt"
DST="/home/pusheen/scratch/small-graph-s-bandwidths/data/small_graph_s_bandwidths.db"
TBL_NAME="con_bip_graphs_1to15"
